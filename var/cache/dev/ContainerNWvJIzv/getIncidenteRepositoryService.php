...
// Returns the private 'App\Repository\IncidenteRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IncidenteRepository.php';

return $this->privates['App\\Repository\\IncidenteRepository'] = new \App\Repository\IncidenteRepository(($this->services['doctrine'] ?? $this->load('getDoctrineService.php')), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->load('getDoctrine_Orm_DefaultEntityManagerService.php')));
